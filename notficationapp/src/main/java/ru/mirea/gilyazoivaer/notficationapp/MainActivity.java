package ru.mirea.gilyazoivaer.notficationapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickNewMessageNotification(View view) {
        ...
        NotificationChannel channel = new NotificationChannel(CHANNEL_ID, "Student Gilyazova E.R. Notification", importance);
